        ...
        <div class="body-wrapper">
            ...
            <main class="min-vh-100 d-flex flex-column justify-content-center align-items-center">
                ...
                <form action="discounts" method="post"
                    ...
                    <h2 class="mb-4 text-center text-dark">Update New Discount</h2>

                    <div class="mb-3">
                        <label class="form-label fs-5 fw-semibold">Discount ID</label>
                        <input type="text" class="form-control form-control-lg" value="${param.id}" disabled>
                        <input type="hidden" name="id" class="form-control form-control-lg" value="${param.id}">
                    </div>
                    
                    <div class="mb-3">
                        <label for="code" class="form-label fs-5 fw-semibold">Discount Code</label>
                        <input type="text" id="code" name="code" value="${discount.code}" class="form-control form-control-lg"  required>
                    </div>

                    <div class="mb-3">
                        <label for="quantity" class="form-label fs-5 fw-semibold">Quantity</label>
                        <input type="number" id="quantity" name="quantity" value="${discount.quantity}" class="form-control form-control-lg" min="0" required>
                    </div>

                    <div class="mb-3">
                        <label for="sale-off" class="form-label fs-5 fw-semibold">Sale Off</label>
                        <input type="number" step="0.01" id="sale-off" name="sale-off"
                               class="form-control form-control-lg" value="${discount.saleOff}" min="1" required>
                    </div>
