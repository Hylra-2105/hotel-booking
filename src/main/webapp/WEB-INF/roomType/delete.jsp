        ...
        <div class="body-wrapper">
            ...
            <main class="min-vh-50 d-flex justify-content-center align-items-center">
                <div class="bg-white shadow rounded-4 p-5 w-100" style="max-width: 600px;">
                    <form action="./room-type?action=delete" method="post" class="text-center">
                        <h2 class="mb-4 text-dark">Room Type Deletion</h2>
                        <p class="fs-5 fw-semibold mb-4">
                            Do you really want to delete <strong>${param.roomType}</strong>
                            with the ID of <strong>${param.id}</strong>?
                        </p>
                        ...
                        <div class="d-flex justify-content-center gap-3">
                            ...
                            <a href="./room-type" class="btn btn-secondary btn-lg px-5 py-2 rounded-3">No</a>
                        </div>
                    </form>
                </div>
            </main>
